...
class Transformer(pl.LightiningModule):
    ...
    def training_step(self, sample, batch_idx):
        ...
        output_rv, output_hr = self.forward(input)
        ...
        loss = self.opt.l1 * loss_rv + self.opt.l2 * loss_hr

        self.log('train_loss', loss) # >>>>>>>>>>>> ADD WHATEVER NEEDS PLOTTING
        return loss
    ...
    def validation_step(self, sample, batch_idx):
        ...
        self.log('val_loss', loss) # >>>>>>>>>>>> ADD WHATEVER NEEDS PLOTTING
        return loss
