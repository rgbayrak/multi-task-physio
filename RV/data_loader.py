...
def get_sub(path):
    ...
    fp.close()
    return gm_fold, rv_fold, ngm_fold
...
def get_dictionary(fold):
    ...
    gm_fold, rv_fold, ngm_fold = get_sub(fold_path)
...
class data_to_tensor():
    ...
    def __init__(self, data, roi_clust, transform=None):
        ...
        # as soon as I pass to the data loader it is gonna create a copy depending on the workers (trveads)
