...
plot_these = ['rv_corr_splits_test_fold_0.txt', 'rv_corr_splits_test_fold_1.txt',
              'rv_corr_splits_test_fold_2.txt', 'rv_corr_splits_test_fold_3.txt',
              'rv_corr_splits_test_fold_4.txt']

# folds together
net_dir = '/home/bayrakrg/neurdy/pycharm/RV/out/results/'
...
plt.savefig('/home/bayrakrg/neurdy/pycharm/RV/figures/rv.png', bbox_inches='tight', dpi=300)
plt.show()
print()