...
# This code splits subject scans into folds while ensuring all scan that belongs to a subject falls under
# either training or test all together

roi_path = "/home/bayrakrg/Data/RVHR/rfMRI/findlab_mat/"
rv_path = "/home/ahmedn1/Physio_goodSub/RV_filt_ds/"
hr_path = "/home/ahmedn1/Physio_goodSub/HR_filt_ds/"
...
files = os.listdir(os.path.join(roi_path))
all_files = os.listdir(os.path.join(roi_path))
