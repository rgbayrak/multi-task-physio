...
log_path = '/home/bayrakrg/neurdy/pycharm/RV/logs'
top = '#!/bin/bash'
				...
				for m in mode:
					...
					for fo in folds:
						if m in fo:
							...
							log_path = '/home/bayrakrg/neurdy/pycharm/RV/logs/{}'.format(uni_id)
							if not os.path.isdir(log_path):
								os.makedirs('/home/bayrakrg/neurdy/pycharm/RV/logs/{}/train'.format(uni_id))
								os.makedirs('/home/bayrakrg/neurdy/pycharm/RV/logs/{}/test'.format(uni_id))
