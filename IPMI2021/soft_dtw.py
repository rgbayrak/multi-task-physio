'''
Soft DTW
https://raw.githubusercontent.com/Sleepwalking/pytorch-softdtw/master/soft_dtw.py
'''
...
#     out = torch.rand([16, 1, 600])
#     target = torch.rand([16, 1, 600])
#     criterion = SoftDTW(gamma=0.2, normalize=True)
