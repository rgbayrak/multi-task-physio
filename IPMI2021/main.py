...
def test_model(opt):
    ...
    fold_file = '/home/bayrakrg/neurdy/pycharm/multi-task-physio/ISBI2020/k_fold_files/' + opt.test_fold
    # fold_file = '/home/bayrakrg/neurdy/pycharm/multi-task-physio/ISBI2020/social_files/' + opt.test_fold
...
def main():
    ...
    parser.add_argument('--uni_id', type=str, default='Bi-LSTM_findlab90fwm_lr_0.001_l1_0.5')
    ...
    parser.add_argument('--out_dir', type=str, default='/home/bayrakrg/neurdy/pycharm/multi-task-physio/ISBI2020/out/', help='Path to output directory')
