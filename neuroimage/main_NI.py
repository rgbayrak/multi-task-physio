...
def main():
    ...
    parser.add_argument('--uni_id', type=str, default='sepCONV1d_schaefertractsegtianaan_lr_0.001_l1_0.5', help='change at every new parameter')
    ...
    parser.add_argument('--out_dir', type=str, default='/home/bayrakrg/neurdy/pycharm/multi-task-physio/neuroimage/out/', help='Path to output directory')
