...
top = '#!/bin/bash'
line = 'python main_NI.py --model={} --uni_id={} --l1={} --out_dir={} --train_fold=train_fold_{}.txt --test_fold=test_fold_{}.txt --mode={}'
		...
		for m in mode:
			...
			for fo in folds:
				if m in fo:
					...
					run = line.format(model, uni_id, l1, out_dir, id, id, m, log_path, uni_id, m, id)
