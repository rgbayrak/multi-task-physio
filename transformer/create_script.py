...
fname = 'transformer_pearson_test.sh'
...
top = '#!/bin/bash'
line = 'python main-transformer.py --model={} --uni_id={} --lr={} --l1={} --l2={} --loss={} --train_fold=train_fold_{}.txt --test_fold=test_fold_{}.txt --decay_rate={} --decay_epoch={} --mode={} > {}/{}/{}.txt'
					...
					for m in mode:
						...
						for fo in folds:
							if m in fo:
								...
								uni_id = '{}_{}_lr_{}_l1_{}_loss_{}'.format(mo, roi[0]+roi[1]+roi[2]+roi[3], lr, l1, loss)
								...
								run = line.format(mo, uni_id, lr, l1, str(round((1-float(l1)), 4)), loss, id, id, decay_rate[i], decay_epoch[i], m, log_path, m, id)
